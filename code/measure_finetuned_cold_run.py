...
FINETUNED_MODEL_PATH = "../qlora_weights/qwen3_ifc_qlora"

TEST_JSON = "../datasets/ifc4_semantic_test.json"

STATISTICS_JSON = "../outputs/finetuned_cold_generation_statistics.json"
...
def run_full_cold_benchmark() -> None:
    ...
    print(
        "RANDOM-SAMPLE FINE-TUNED COLD-START LATENCY BENCHMARK"
    )
    ...
    print(
        f"LoRA adapter           : {FINETUNED_MODEL_PATH}"
    )
    print(
        "=" * 72
    )
    ...
    print(
        "FINE-TUNED COLD-START LATENCY SUMMARY"
    )
